...
- [x] **Step 1: Write the failing long-route test**
...
- [x] **Step 2: Run the new test and verify the fixed 5 m behavior fails**
...
- [x] **Step 3: Implement the minimal adaptive default**
...
- [x] **Step 4: Add and run the rejection test**
...
- [x] **Step 7: Validate against the existing real reconstruction and commit**
