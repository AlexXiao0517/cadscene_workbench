...
def build_colmap_cli_commands(
    ...
    *,
    ...
    ba_global_frames_ratio: float,
    ba_global_points_ratio: float,
    ba_global_frames_freq: int,
    ba_global_points_freq: int,
    ba_global_max_num_iterations: int,
    ba_global_max_refinements: int,
    use_mask: bool,
    use_gpu: bool,
    gpu_index: str,
    feature_help: str,
...
def run_colmap_cli_pipeline(
    ...
    *,
    ...
    commands = build_colmap_cli_commands(
        ...
        ba_global_frames_ratio=ba_global_frames_ratio,
        ba_global_points_ratio=ba_global_points_ratio,
        ba_global_frames_freq=ba_global_frames_freq,
